...
public class ECSStack extends Stack {
    ...
    public ECSStack(Construct scope, String id, String appName, StackProps props){
    ...
    public DockerImageAsset createDockerAsset(){
        ...
        DockerImageAsset dockerAsset = DockerImageAsset.Builder
            ...
            .directory("./target")//make sure that Dockerfile gets copied to /target during maven compile/package
            .build();
        return dockerAsset;
    }
